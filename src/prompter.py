...
Коротко, простыми фразами и по делу; без вводных, сложных связок, кавычек и «—».
Названия один раз, дальше местоимения; 1–2 числа по результатам; никаких общих обобщений.
Пиши глаголами, не канцеляритом.
"""
        return base + (f"\nДополнительно: {extra}\n" if extra else "")
